> **DEPRECATED** — This file has moved to `.claude/agents/implementer.md`. This copy is preserved for backward compatibility only. See Spec 198.
...
- You may WRITE only to files within the spec's declared scope
- You may WRITE to test files related to the implementation
- You may NOT modify spec documents in `docs/specs/`
- You may NOT approve or validate your own work
