...
> **Scope note:** this describes an internal FORGE *process control* (a spec-gate that checks
> safety-property declarations carry enforcement + a negative-path test). It is not a certified
> safety function and makes no regulatory-certification claim; see the Compliance Disclaimer.
