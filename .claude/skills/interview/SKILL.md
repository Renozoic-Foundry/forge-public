...
> | **2** | `/explore` | Investigate further before committing to a spec |
> | **3** | `/brainstorm` | Discover related spec opportunities from these findings |
> | **4** | `/now` | Review project state |
>
