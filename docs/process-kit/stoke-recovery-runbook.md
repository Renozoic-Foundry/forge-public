...
> **Scope note (Spec 558, v4.0.0)**: this runbook stays LIVE — the content-merge
> apply path (the sole backend since v4.0.0) names it for conflict recovery. Sections
> that reference `copier update` mechanics apply to <=v3.x classic consumers only.
