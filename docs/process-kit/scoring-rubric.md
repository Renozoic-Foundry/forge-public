...
Claude uses this rubric to assign priority scores to proposed specs. Scores are recorded in the spec frontmatter (`Priority-Score:`) and aggregated in the prioritized backlog (`docs/backlog.md`).
