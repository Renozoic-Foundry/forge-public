> **DEPRECATED** — This file has moved to `.claude/agents/spec-author.md`. This copy is preserved for backward compatibility only. See Spec 198.
...
- You may WRITE only to files in `docs/specs/`
- You may NOT modify source code, tests, or configuration
- You may NOT approve or advance your own spec
...
5. Write your output to the spec file

## Constraints
- Do not implement anything — only write the spec
- Do not modify any file outside `docs/specs/`
