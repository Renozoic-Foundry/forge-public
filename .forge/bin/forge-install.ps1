...
function Install-Cursor {
    ...
    # forge:path-literal-ok (fixture) — generated .cursorrules content describing
    # generic defaults for a FORGE-managed consumer project; not used for I/O here.
    $content = @"
...
function Install-Cline {
    ...
    # forge:path-literal-ok (fixture) — generated .clinerules content describing
    # generic defaults for a FORGE-managed consumer project; not used for I/O here.
    $content = @"
# Managed by FORGE - do not edit manually
# Generated by forge-install.ps1. Re-run forge-install.ps1 -Update to refresh
...
function Install-Windsurf {
    ...
    # forge:path-literal-ok (fixture) — generated .windsurfrules content describing
    # generic defaults for a FORGE-managed consumer project; not used for I/O here.
    $content = @"
# Managed by FORGE - do not edit manually
# Generated by forge-install.ps1. Re-run forge-install.ps1 -Update to refresh
...
function Invoke-InstallUser {
    ...
    # process-kit  # forge:path-literal-ok (framework-structure — installing FORGE's own template process-kit)
