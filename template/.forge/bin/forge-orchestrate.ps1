# forge-orchestrate.ps1 — PowerShell wrapper for forge-orchestrate.sh

$ErrorActionPreference = "Stop"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$BashScript = Join-Path $ScriptDir "forge-orchestrate.sh"
...
$TempFile = Join-Path $env:TEMP "forge-orchestrate-$PID.sh"
