#!/usr/bin/env bash
# forge:path-literal-ok (file: legacy-bootstrap installer — renders classic-layout guidance text and framework-repo structure by design; Spec 575)
...
install_cursor() {
  ...
  # forge:path-literal-ok (fixture) — generated .cursorrules content describing generic
  # defaults for a FORGE-managed consumer project; not used for I/O by this script.
...
install_copilot() {
  ...
  # forge:path-literal-ok (fixture) — generated Copilot instructions content describing
  # generic defaults for a FORGE-managed consumer project; not used for I/O by this script.
...
install_cline() {
  ...
  # forge:path-literal-ok (fixture) — generated .clinerules content describing generic
  # defaults for a FORGE-managed consumer project; not used for I/O by this script.
  cat > "$target_file" <<'RULES'
# Managed by FORGE — do not edit manually
# Generated by forge-install.sh. Re-run forge-install.sh --update to refresh
...
install_windsurf() {
  ...
  # forge:path-literal-ok (fixture) — generated .windsurfrules content describing generic
  # defaults for a FORGE-managed consumer project; not used for I/O by this script.
  cat > "$target_file" <<'RULES'
# Managed by FORGE — do not edit manually
# Generated by forge-install.sh. Re-run forge-install.sh --update to refresh
...
do_install_user() {
  ...
  # process-kit lives in docs/process-kit/ relative to the project root  # forge:path-literal-ok (framework-structure — installing FORGE's own template process-kit)
