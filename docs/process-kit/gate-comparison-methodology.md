...
> **Scope note:** an internal FORGE process-tooling methodology (comparing review-gate outputs
> offline). Not a certification process or a regulatory-compliance claim.
