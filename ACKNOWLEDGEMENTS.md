...
| **Context Anchoring** | Rahul Garg (published on martinfowler.com) | 2026 | Specs as living documents that persist decision context across AI sessions |
| **Agentic AI Foundation (AAIF)** | Linux Foundation | 2025 | `AGENTS.md` bounded autonomy, delegation contracts, and prohibited actions |

## Key Influences

- **Rahul Garg** — [Context anchoring](https://martinfowler.com/articles/reduce-friction-ai/context-anchoring.html) (published on martinfowler.com). His 2026 writing independently validated the spec-as-context-anchor pattern FORGE had practiced from the start.
- **Martin Fowler / Thoughtworks** — Architecture Decision Records (amplified from Nygard), encoding standards, and the martinfowler.com platform where context anchoring was published.
